  ...
  return (
    <div
      className={cn(
        ...
        // Added mask-image to fade the top and bottom edges, removing the hard "border" lines
        "[mask-image:linear-gradient(to_bottom,transparent,black_5%,black_90%,transparent)]",
        `opacity-[var(--opacity)]`,
        className
      )}
      style={gridStyles}
